...
HD_PWD='C:/Users/asus/Desktop/Bilkent 201/Cs 223/Project/TetrisFinal/TetrisFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GameControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GameControl.tcl
